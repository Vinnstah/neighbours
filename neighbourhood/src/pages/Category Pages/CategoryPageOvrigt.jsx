...
function CategoryPageOvrigt() {
  ...
  fetch('/products.json')
    .then(res => res.json())
    .then(data => {
      const filtered = data.filter(product => product.productCat.toLowerCase() === "övrigt");
...
export default CategoryPageOvrigt;