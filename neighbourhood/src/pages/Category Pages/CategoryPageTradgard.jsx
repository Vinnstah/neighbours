...
function CategoryPageTradgard() {
  ...
  fetch('/products.json')
    .then(res => res.json())
    .then(data => {
      const filtered = data.filter(product => product.productCat.toLowerCase() === "trädgård");
...
export default CategoryPageTradgard;